        ...
        <PicBox>
          <picture>
            <img
              ...
              alt="Page not found"
            />
            <source media="(min-width: 768px)" srcSet={`${notfound1x_tablet}, ${notfound2x_tablet} 2x`} />
            <source media="(min-width: 1440px)" srcSet={`${notfound1x_desktop}, ${notfound2x_desktop} 2x`} />
          </picture>
        </PicBox>
        <TextBox>
